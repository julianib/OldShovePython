from poker import Player, best_possible_hand, Hand
...
class Pot:
    ...
    def get_winners(self, shared_cards):
        winners = []
        best_hand: Hand = None
...
class PotManager:
    ...
    def new_hand(self, players) -> None:
    ...
    def handle_call(self, player: Player) -> None:
        new_amount = player.set_bet(min(player.max_bet, self.cur_bet))
